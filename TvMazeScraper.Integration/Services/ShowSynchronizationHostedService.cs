...
namespace TvMazeScraper.Integration.Services
{
    internal class SynchronizationHostedService : IHostedService, IDisposable
    {
        ...
        public SynchronizationHostedService(ILogger<SynchronizationHostedService> logger, ISynchronizationService synchronizationService, ISynchronizationConfiguration config)
        {
            _logger = logger;
