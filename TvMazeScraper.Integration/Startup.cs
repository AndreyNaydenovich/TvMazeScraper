...
namespace TvMazeScraper.Integration
{
    public class Startup
    {
        ...
        {
            services.AddSingleton(Configuration.GetSection("SynchronizationConfiguration").Get<SynchronizationConfiguration>());
            services.AddSingleton(Configuration.GetSection("ApiClientConfiguration").Get<ApiClientConfiguration>());
